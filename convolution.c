...
******************************************************************************
Modified:
Author:  Hao Xue, China University of Petroleum, 2017-03-10
Note:
	1. Delete if-define and keep the long conv code, or the code cannot run
*****************************************************************************/
/**************** end self doc ********************************/
...
*****************************************************************************/
{
	int ilx,ily,ilz,i,j,ilow,ihigh,jlow,jhigh;
